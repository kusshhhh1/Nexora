  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        await register(formData.email, formData.password, formData.name, 'organizer');
      ...
      <div className="relative z-10 max-w-md w-full">
        <motion.div
          ...
          className="bg-black/80 backdrop-blur-md border border-nexora-purple/20 rounded-2xl shadow-2xl p-8"
            ...
            <h2 className="text-3xl font-bold bg-gradient-to-r from-nexora-blue to-nexora-pink bg-clip-text text-transparent mb-2">
              {isLogin ? 'Welcome Back' : 'Create Account'}
            </h2>
            <p className="text-gray-300">
              {isLogin ? 'Sign in to manage your events' : 'Join as an event organizer'}
            </p>
            <div className="mt-4">
              <Link 
                to="/"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3 bg-nexora-purple/20 border border-nexora-purple/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-nexora-pink focus:border-transparent transition-all duration-300 pr-12"
          ...
          <div className="mt-8 text-center">
            ...
            <div className="mt-4 text-sm text-gray-400">
              ...
              <Link to="/attendee/auth" className="text-nexora-pink hover:text-nexora-blue transition-colors">
                Join as Attendee
              </Link>
            </div>
          </div>
